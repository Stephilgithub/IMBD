...
select year, substr(date_published,4,2) as month, count(id) as movies_released from movies 
...
select count(*) from movies where year = 2019 and  country in ('USA','INDIA');
